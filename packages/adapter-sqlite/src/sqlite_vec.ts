...
export function loadVecExtensions(db: Database): void {
  try {
    ...
    const vecPath = '/home/caveman/projects/bots/venv/elizaOS_env/agentVooc-prod/node_modules/.pnpm/sqlite-vec-linux-x64@0.1.6/node_modules/sqlite-vec-linux-x64/vec0.so';
    elizaLogger.info(`Attempting to load sqlite-vec extension from: ${vecPath}`);
