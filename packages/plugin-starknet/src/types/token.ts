...
export interface CalcInput {
  type: "fee_estimate" | "strk_to_usd" | "solve_equation"; // Adapted for Starknet
  [key: string]: any; // e.g., amountStrk, feeRate, equation
}

export interface CalcResult {
  value: any; // e.g., feeStrk or { integral: number, fraction: number }
  provenance: { scarbVersion: string; commitHash: string };
}
